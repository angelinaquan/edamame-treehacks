...
CREATE TABLE documents (
  ...
  content TEXT,
  file_url TEXT,
  doc_type TEXT CHECK (doc_type IN ('slack_message', 'document', 'meeting_notes', 'email', 'notion_page', 'github_commit', 'jira_ticket', 'gdrive_doc', 'google_drive_file')) DEFAULT 'document',
  created_at TIMESTAMPTZ DEFAULT NOW()
);
...
-- ============================================
-- Memory Pipeline Tables (synthetic ingestion & compaction)
-- ============================================
