  ...
  const basePeople: SyntheticPerson[] = [
    {
      ...
      opinions: [
        "I think Edamame is the strongest idea we've had all night. The memory layer concept is technically novel but also extremely demoable — you can literally show a digital twin answering questions with real context. That's the magic moment judges remember.",
        ...
        "I was initially skeptical of the AI workforce idea but Videet's multi-agent framework was actually impressive. The problem was iteration speed — you can't fine-tune models at a hackathon. But the agent-to-agent communication protocol we built is genuinely useful and we're reusing it in Edamame for clone consultation.",
        "My biggest concern with Edamame right now is scope. Angelina wants to show everything — onboarding, offboarding, memory explorer, CEO insights, clone chat, voice mode. That's 6+ features. I'd rather show 3 polished features than 6 broken ones. Judges care about 'does it work live' more than 'how many features does it have.'",
        "The RAG pipeline is the technical core of Edamame and I'm proud of how it turned out. The retrieval quality is surprisingly good — when you ask a clone a question, the cited sources are actually relevant. That's not easy to get right, especially with mixed data sources (Slack + Drive + email).",
        ...
        "Honestly, I think the pivot journey IS part of our product story. We experienced organizational memory loss during our own pivots — we literally lost context about decisions we'd made 3 hours earlier. That's the pain point Edamame solves, and we can tell that story authentically because we lived it.",
        "The continual learning feature is what makes Edamame different from just another RAG chatbot. The clone doesn't just search static documents — it actually gets smarter over time from every conversation. That's the research contribution: a memory system that compounds.",
    ...
    },
    {
      ...
      opinions: [
        "I think Edamame is a great idea but we need to focus on reliability over features. The clone chat throws 500 errors ~10% of the time and we can't have that in a live demo. I'd rather fix the bugs we have than add new features.",
        ...
        "I wasn't sold on the AI workforce idea because fine-tuning is slow and expensive. But Videet was passionate about it and I respected that. The multi-agent coordination code turned out to be valuable for Edamame anyway.",
        "My contribution to Edamame is less glamorous than the AI stuff — I built the database schema, the integration APIs, the OAuth flows, the webhook handlers. It's plumbing, but without it nothing works. The Slack webhook is my favorite thing I built — seeing a message appear in Slack and then watching the clone learn it in real-time is magical.",
    ...
    },
    {
      ...
      opinions: [
        ...
        "I pushed for keeping ALL the features in the demo because I believe the breadth of Edamame is what makes it impressive. Clone chat alone is just another chatbot. But clone chat + CEO insights + continual learning + onboarding briefs + offboarding handoffs? That's a PLATFORM. That's what wins hackathons.",
        ...
        "I think the ambient listener idea was technically interesting but had terrible UX. 'We're always listening to you' is not a product pitch that inspires trust. Edamame is better because the data ingestion is explicit — you connect your Slack, your Drive, your email. The user is in control.",
        "The AI workforce idea was Videet's baby and I respect the technical ambition. But from a product perspective, 'specialized agents fine-tuned with LoRA' doesn't translate to a compelling demo. Users don't care about model weights — they care about answers. Edamame gives them answers.",
        ...
        "For the demo narrative, I think we should be honest about the pivots. 'We tried three ideas in one night' shows intellectual honesty and adaptability. The fact that code from abandoned ideas (Whisper from ambient listener, agent protocol from workforce) ended up in Edamame is a great story arc.",
    ...
    },
    {
      ...
      opinions: [
        ...
        "Edamame is a good idea and I'm glad we converged on it. The memory layer concept is sound — embeddings + pgvector + RAG is a well-understood stack that we can execute on in a few hours. It's not as novel as the other ideas but it's highly demoable and that's what matters at a hackathon.",
        "I think the technical core of Edamame — the embedding pipeline — is where I add the most value. I chose text-embedding-3-small over the large variant (1536-d vs 3072-d) because the latency difference matters for real-time chat. I also set up embedding caching so repeat queries skip the API call entirely. These decisions make the difference between a smooth demo and a laggy one.",
        "The voice mode is something I'm particularly proud of. I built the Whisper transcription pipeline for the ambient listener and we're now reusing it for voice input in Edamame. I also added TTS for voice output. So you can literally talk to the clone and hear it respond. The speech model work I did at Sarvam AI directly prepared me for this.",
        ...
        "I think the agent-to-agent communication protocol from the AI workforce idea is the most underrated piece of code we wrote tonight. The clone consultation feature in Edamame — where one clone asks another for context it doesn't have — uses that exact protocol. So our 'failed' ideas actually contributed directly to the final product.",
