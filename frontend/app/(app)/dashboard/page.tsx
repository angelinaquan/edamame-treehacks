...
export default function DashboardPage() {
  ...
  const mockConversations = [
    {
      id: "1",
      clone_name: "Sarah Chen",
      user_name: "Alex Morgan",
      last_message: "What's the latest on the TechFlow deal?",
      timestamp: "2 min ago",
      has_collaboration: true,
    },
    {
      id: "2",
      clone_name: "Jason Park",
      user_name: "Alex Morgan",
      last_message: "When is SSO going to be ready?",
      timestamp: "15 min ago",
      has_collaboration: false,
    },
    {
      id: "3",
      clone_name: "Alex Morgan",
      user_name: "Sarah Chen",
      last_message: "Can you review the phased rollout plan?",
